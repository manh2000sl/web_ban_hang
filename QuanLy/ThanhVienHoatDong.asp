	...
	<tr>
    	<td width="22%" valign="top">
        	<ul style="display:block; padding:0px; list-style-type:none; margin-right:20px;">
                ...
                <li class="hoatdongtk" style="color:#F00">Thành viên hoạt động</li>
        ...
        <td width="78%" valign="top">
        	<%
				...
				//tạo câu lệnh SQL
				sSQL = "SELECT * FROM ThanhVien WHERE HoatDong = 'YES'";
            ...
            <form action="KhoaThanhVien.asp" style="color:rgb(3,201,191)">
                ...
                <input class="nutlogin" type="submit" value="Khoá Thành Viên">
            </form>
            </div>
            <br><br>
            <%
