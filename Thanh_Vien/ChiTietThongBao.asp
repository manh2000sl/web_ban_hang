...
<table class="div" width="100%">
	<tr>
        ...
        <td width="80%" valign="top">
            ...
            <%
                var ThoiGianTL = Request("ThoiGianTL");
				cnn=Server.CreateObject("ADODB.Connection");
				cnn.Open(cStr);
				rs=Server.CreateObject("ADODB.Recordset");
				ChiTietTB = "SELECT * FROM PhanHoiTV WHERE ThoiGianTL = '"+ThoiGianTL+"' AND ThanhVien = '"+Session("Ten")+"' UPDATE PhanHoiTV SET TrangThai = 'DADOC' WHERE ThoiGianTL = '"+ThoiGianTL+"' AND ThanhVien = '"+Session("Ten")+"'";
			...
			%>
                <table>
                    <tr>
                        <td width="100%" valign="top"><strong>Chủ đề:</strong><b style="color:red;font-weight:bold;"><%=ChuDe%></b><br />
                            <b>Thời gian thông báo:</b> <%=ThoiGianTL%><br />
                            <b>Nội dung thông báo:</b><br /> <textarea disabled style="background-color:rgb(224, 221, 206); border:groove 1px; color:black;resize:none;" rows="5" cols="50"><%=NDTraLoi%></textarea>
                        </td>
                    </tr>
                </table>
    </tr>
