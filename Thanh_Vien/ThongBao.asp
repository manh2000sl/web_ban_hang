	...
	<tr>
        ...
        <td width="80%" valign="top">
            ...
            <ul>
            	...
            	<li class="HoatDongPH">Tất cả thông báo</li>
            ...
            <%
				...
				CHUADOC = "SELECT * FROM PhanHoiTV WHERE ThanhVien = '"+Session("Ten")+"' AND TrangThai = 'CHUADOC' ORDER BY MaPH DESC";
				rs.Open(CHUADOC,cnn);
                if(!rs.EOF){
				var index1=0;
				rs.MoveFirst();
				while(!rs.EOF){
                    ...
                    if(ThoiGianPH == ''){
			%>
            <form action="ChiTietThongBao.asp">
                <table style="border:solid 0px; border-radius:20px; background-color:rgb(255, 85, 199); padding:10px;" width="68%">
                    <tr>
                        <td width="69%"><b>Thông báo</b></td>
                        <td width="31%" align="right"><input type="text" style="border:none; background-color:rgb(255, 85, 199);" name="ThoiGianTL" value="<%=ThoiGianTL%>" readonly></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="left">Chủ đề: <input type="submit" style="border:none; background-color:rgb(255, 85, 199); cursor:pointer;outline:none;" value="<%=ChuDe%>"></td>
                    </tr>
                </table>
            </form><br>
          	<%
            ...
            <%
				...
				DADOC = "SELECT * FROM PhanHoiTV WHERE ThanhVien = '"+Session("Ten")+"' AND TrangThai = 'DADOC' ORDER BY MaPH DESC";
				rsDD.Open(DADOC,cnnDD);
				if(!rsDD.EOF){
				var index2=0;
				rsDD.MoveFirst();
				while(!rsDD.EOF){
					...
					MaPHDD = rsDD.Fields.Item("MaPH").Value;
            ...
            <form action="ChiTietThongBao.asp">
                <table style="border:solid 0px; border-radius:20px; background-color:#E6E6E6; padding:10px;" width="68%">
                    <tr>
                        <td width="69%"><b>Thông báo</b></td>
                        <td width="31%" align="right"><input type="text" style="border:none; background-color:#E6E6E6;" name="ThoiGianTL" value="<%=ThoiGianTLDD%>" readonly></td>
                    </tr>
                    <tr>
